...
module.exports = (req, res, next) => {
  ...
  res.getModelList = async function (Model, customFilters = {}, populate = null) {//customfilters burada departmana göre listelenecek personeller için getirildi. 
  ...
  // Details://customfilters burada departmana göre listelenecek personeller için getirildi. 
